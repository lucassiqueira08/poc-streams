...
const buildLine = ({
  ...
  const operationHash = `${operationDateFormatted} - ${batch.endorid * 33e4}`
  const ruHash = `${operationDateFormatted} - ${batch.endorid * 56e4}`

  return [
    { start: 0, end: 1, value: '20' },
    { start: 2, end: 15, value: batch.vendorid },
    { start: 16, end: 47, value: batch.passenger_count },
    { start: 48, end: 48, value: '' },
    { start: 49, end: 80, value: batch.pulocationid },
    { start: 81, end: 81, value: '' },
    { start: 82, end: 113, value: ruHash },
    { start: 114, end: 114, value: '' },
    { start: 115, end: 146, value: operationHash },
    { start: 147, end: 147, value: batch.trip_distance },
    ...
    { start: 174, end: 205, value: batch.tpep_dropoff_datetime },
    { start: 206, end: 206, value: batch.extra },
    { start: 207, end: 218, value: netPrePayAmount },
    { start: 219, end: 219, value: batch.total_amount },
    { start: 220, end: 220, value: 1 },
    { start: 221, end: 313, value: batch.fare_amount },
    { start: 314, end: 319, value: counterLine },
    { start: 320, end: 321, value: helper.EOL },
  ]
}

const buildObject = operationDate => (batch, index) => {
  const netPrePayAmount = batch.total_amount - batch.mta_tax - batch.extra
